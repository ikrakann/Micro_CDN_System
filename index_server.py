...
def get_alive_servers_from_monitor():
    """
    Sends the LIST_SERVERS command to the Monitor over TCP
    and returns a set of server_ids that are marked as alive.
    Returns an empty set if the Monitor is unreachable.
    """
    alive = set()
    try:
